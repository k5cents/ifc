...
This outlines how to propose a change to ifc.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("k5cents/ifc", fork = TRUE)`.
