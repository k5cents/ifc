...
This outlines how to propose a change to ifc. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("k5cents/ifc", fork = TRUE)`.
...
Conduct](https://k5cents.github.io/ifc/CODE_OF_CONDUCT.md). By
